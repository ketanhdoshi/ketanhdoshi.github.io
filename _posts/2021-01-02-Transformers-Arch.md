...
2. **How it works** — this article (_Internal operation end-to-end. How data flows and what computations are performed, including matrix representations_)
...
![(Image by Author)]({{ site.baseurl }}/assets/images/TransformerArch/Arch-1.png)
...
![(Image by Author)]({{ site.baseurl }}/assets/images/TransformerArch/Embedding-3.png)
...
![(Image by Author)]({{ site.baseurl }}/assets/images/TransformerArch/Embedding-1.png)
...
![(Image by Author)]({{ site.baseurl }}/assets/images/TransformerArch/Embedding-5.png)
...
![(Image by Author)]({{ site.baseurl }}/assets/images/TransformerArch/Embedding-7.png)
...
![(Image by Author)]({{ site.baseurl }}/assets/images/TransformerArch/Embedding-4.png)
...
![(Image by Author)]({{ site.baseurl }}/assets/images/TransformerArch/Embedding-2.png)
...
![(Image by Author)]({{ site.baseurl }}/assets/images/TransformerArch/Embedding-6.png)
...
![(Image by Author)]({{ site.baseurl }}/assets/images/TransformerArch/Encoder-1.png)
...
![(Image by Author)]({{ site.baseurl }}/assets/images/TransformerArch/Encoder.png)
...
![(Image by Author)]({{ site.baseurl }}/assets/images/TransformerArch/Decoder.png)
...
![(Image by Author)]({{ site.baseurl }}/assets/images/TransformerArch/Attention-2.png)
...
![(Image by Author)]({{ site.baseurl }}/assets/images/TransformerArch/Attention-3.png)
...
![(Image by Author)]({{ site.baseurl }}/assets/images/TransformerArch/Attention-4.png)
...
![(Image by Author)]({{ site.baseurl }}/assets/images/TransformerArch/Masking-1.png)

Similarly for the Encoder-Decoder attention.

![(Image by Author)]({{ site.baseurl }}/assets/images/TransformerArch/Masking-2.png)
...
![(Image by Author)]({{ site.baseurl }}/assets/images/TransformerArch/Masking-4.png)

Therefore, the Decoder masks out input words that appear later in the sequence.

![(Image by Author)]({{ site.baseurl }}/assets/images/TransformerArch/Masking-3.png)
...
![(Image by Author)]({{ site.baseurl }}/assets/images/TransformerArch/Output.png)
...
![(Image by Author)]({{ site.baseurl }}/assets/images/TransformerArch/Loss.png)
