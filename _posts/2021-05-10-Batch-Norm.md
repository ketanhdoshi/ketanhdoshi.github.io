...
Then during gradient descent, in order to "move the needle" for the Loss, the network would have to make a large update to one weight compared to the other weight. This can cause the gradient descent trajectory to oscillate back and forth along one dimension, sthus taking more steps to reach the minimum.
...
## Conclusion
Batch Norm is a very useful technique which you will end up using often in your network architecture. Hopefully this gives you a good understanding of _how_ Batch Norm works.
