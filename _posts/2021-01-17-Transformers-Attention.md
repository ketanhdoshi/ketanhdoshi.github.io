...
Photo by [Scott Tobin](https://unsplash.com/@scottywatty) on [Unsplash](https://unsplash.com)
...
1. **Overview of functionality** (_How Transformers are used, and why they are better than RNNs. Components of the architecture, and behavior during Training and Inference_)
...
3. **Multi-head Attention** — this article (_Inner workings of the Attention module throughout the Transformer_)
...
![(Image by Author)]({{ site.baseurl }}/assets/images/TransformerAttn/Attn-1.png)
...
![(Image by Author)]({{ site.baseurl }}/assets/images/TransformerAttn/Attn-2.png)
...
![(Image by Author)]({{ site.baseurl }}/assets/images/TransformerArch/Attention-1.png)
...
![(Image by Author)]({{ site.baseurl }}/assets/images/TransformerAttn/Input-1.png)

To make it simple to visualize, we will drop the Batch dimension in our pictures and focus on the remaining dimensions.

![(Image by Author)]({{ site.baseurl }}/assets/images/TransformerAttn/Input-2.png)
...
![(Image by Author)]({{ site.baseurl }}/assets/images/TransformerAttn/Linear.png)
...
![(Image by Author)]({{ site.baseurl }}/assets/images/TransformerAttn/Split-1.png)
...
![(Image by Author)]({{ site.baseurl }}/assets/images/TransformerAttn/Split-2.png)
...
![The Q matrix is reshaped to include a Head dimension and then reshaped again by swapping the Head and Sequencd dimensions. (Image by Author)]({{ site.baseurl }}/assets/images/TransformerAttn/Split-3.png)
...
![Q matrix split across the Attention Heads (Image by Author)]({{ site.baseurl }}/assets/images/TransformerAttn/Split-5.png)
...
![(Image by Author)]({{ site.baseurl }}/assets/images/TransformerAttn/Score-1.png)
...
![(Image by Author)]({{ site.baseurl }}/assets/images/TransformerAttn/Merge-1.png)

## End-to-end Multi-head Attention
Putting it all together, this is the end-to-end flow of the Multi-head Attention.

![(Image by Author)]({{ site.baseurl }}/assets/images/TransformerAttn/Multi-1.png)
...
![(Image by Author)]({{ site.baseurl }}/assets/images/TransformerAttn/Split-4.png)
...
![(Image by Author)]({{ site.baseurl }}/assets/images/TransformerAttn/Decoder%20Attn.png)
...
![(Image by Author)]({{ site.baseurl }}/assets/images/TransformerAttn/Encoder-Decoder%20Attn.png)
