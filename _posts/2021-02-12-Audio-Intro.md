...
Photo by [Jason Rosewell](https://unsplash.com/@jasonrosewell) on [Unsplash](https://unsplash.com)
...
1. **State-of-the-Art Techniques** — this article (_What is sound and how it is digitized. What problems is audio deep learning solving in our daily lives. What are Spectrograms and why they are all-important._)
...
![Simple repeating signal showing Amplitude vs Time (by permission of Prof Mark Liberman)]({{ site.baseurl }}/assets/images/AudioIntro/Sound-1.png)
...
![Musical waveform with a complex repeating signal (Source, by permission of Prof George Gibson)]({{ site.baseurl }}/assets/images/AudioIntro/Sound-7.png)
...
![Sample measurements at regular time intervals (Source)]({{ site.baseurl }}/assets/images/AudioIntro/Sound-10.png)
...
![Spectrum showing the frequencies that make up a sound signal (Source, by permission of Prof Barry Truax)]({{ site.baseurl }}/assets/images/AudioIntro/Sound-9.png)
...
![Time Domain and Frequency Domain (Source)]({{ site.baseurl }}/assets/images/AudioIntro/Sound-4.png)
...
![Sound signal and its Spectrogram (Image by Author)]({{ site.baseurl }}/assets/images/AudioIntro/Sound-6.png)
...
![Typical pipeline used by audio deep learning models (Image by Author)]({{ site.baseurl }}/assets/images/AudioIntro/Arch-1.png)
...
![Classification of Ordinary sounds (Image by Author)]({{ site.baseurl }}/assets/images/AudioIntro/App-2.png)
...
![Separating individual speakers from a video (Source, by permission of Ariel Ephrat)]({{ site.baseurl }}/assets/images/AudioIntro/App-1.png)
...
![Music Genre Classification and Tagging (Image by Author)]({{ site.baseurl }}/assets/images/AudioIntro/App-3.png)
...
![Music Generation (Image by Author)]({{ site.baseurl }}/assets/images/AudioIntro/App-5.png)
...
![Voice Recognition for Intruder Detection (Image by Author)]({{ site.baseurl }}/assets/images/AudioIntro/App-4.png)
...
W
e could apply this to animal voices to identify the type of animal that is producing a sound, or potentially to identify whether it is a gentle affectionate purring sound, a threatening bark, or a frightened yelp.
...
![Speech to Text (Image by Author)]({{ site.baseurl }}/assets/images/AudioIntro/App-6.png)
